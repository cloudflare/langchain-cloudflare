"""CloudflareWorkersAI vector stores."""
...
class CloudflareWorkersAIVectorStore(VectorStore):
    # TODO: Replace all TODOs in docstring.
    """CloudflareWorkersAI vector store integration.
    ...
    Instantiate:
        .. code-block:: python
            ...
            vector_store = CloudflareWorkersAIVectorStore(
                collection_name="foo",
    ...
    @classmethod
    def from_texts(
        cls: Type[CloudflareWorkersAIVectorStore],
        texts: List[str],
