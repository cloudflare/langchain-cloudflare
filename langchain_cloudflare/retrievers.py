"""CloudflareWorkersAI retrievers."""
...
class CloudflareWorkersAIRetriever(BaseRetriever):
    ...
    """CloudflareWorkersAI retriever.

    # TODO: Replace with relevant packages, env vars, etc.
    Setup:
        Install ``langchain-cloudflare`` and set environment variable
        ``CLOUDFLARE_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-cloudflare import CloudflareWorkersAIRetriever

            retriever = CloudflareWorkersAIRetriever(
                # ...
            )
