"""CloudflareWorkersAI document loader."""
...
class CloudflareWorkersAILoader(BaseLoader):
    ...
    """
    CloudflareWorkersAI document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import CloudflareWorkersAILoader

            loader = CloudflareWorkersAILoader(
                # required params = ...
                # other params = ...
            )
